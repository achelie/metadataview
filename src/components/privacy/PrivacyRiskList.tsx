...
const categories: Array<{ id: CategoryFilter; label: string }> = [{id:'all',label:'All'},{id:'location',label:'Location'},{id:'identity',label:'Identity'},{id:'device',label:'Device'},{id:'time',label:'Time'},{id:'editing',label:'Editing'}];
