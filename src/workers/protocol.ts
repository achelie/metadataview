import type { DetectedFileType, NormalizedImageMetadata, ParsedMetadata } from '../lib/metadata/types';
import type { PrivacyReport } from '../lib/privacy/types';
import type { MetadataReport } from '../lib/metadata-report/types';

export type WorkerRequest =
  | { id: string; type: 'parse-metadata'; file: File; allowedTypes?: DetectedFileType[] }
  | { id: string; type: 'inspect-metadata'; file: File; allowedTypes?: DetectedFileType[] }
