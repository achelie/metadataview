...
export const tools: Record<string, ToolConfig> = {
  metadata: {
    ...
    description: 'Open image, document, video, and audio metadata across 17 supported file extensions. Search fields, copy values, and export the complete result without uploading the file.',
    ...
    formats: 'JPEG · PNG · WebP · PDF · DOCX · PPTX · XLSX · MP4 · MP3 · FLAC · OGG · OPUS · OGA · M4A · AAC · WAV · WMA', accept: '.jpg,.jpeg,.png,.webp,.pdf,.docx,.pptx,.xlsx,.mp4,.mp3,.flac,.ogg,.opus,.oga,.m4a,.aac,.wav,.wma', allowedTypes: ['jpeg','png','webp','pdf','docx','pptx','xlsx','mp4','mp3','flac','ogg','opus','m4a','aac','wav','wma'],
