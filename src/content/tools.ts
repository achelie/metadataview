...
export const tools: Record<string, ToolConfig> = {
  metadata: {
    ...
    description: 'Open image, document, video, and audio metadata across 25 supported file extensions. Search fields, copy values, and export the complete result without uploading the file.',
